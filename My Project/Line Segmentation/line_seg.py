...
#--- and 10 columns to join neighboring letters in words and neighboring words
    ...
    erode = cv2.erode(dilation, rect_kernel, iterations=2)
    ...
    cv2.drawContours(cont_img, contours, -1, (255,0,255), 5)
...
#        if cv2.contourArea(cnt) > 5:
         ...
         show_wait_destroy("Regions Of Interest", ROI)
    ...
    cv2.imwrite("Results/segmented image.jpg", chr_img)
